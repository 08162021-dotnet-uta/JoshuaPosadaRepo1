...
<div class="col mb-5 outofstock">
    <div class="card h-100 outofstock">
        ...
        <div class="card-body p-4outofstock">
        ...
        <div class="card-footer p-4 pt-0 border-top-0 bg-transparent outofstock">
            <div class="text-center outofstock">
                <div class="btn btn-outline-dark mt-auto disabled outofstock ">
                    ...
                    lop.innerHTML += `
    <div class="col mb-5 outofstock" onmouseover="sessionStorage.ProductPrice=${data[x].productPrice}">
        <div class="card h-100 outofstock" onmouseover="sessionStorage.productid=${data[x].productId}">

            <div class="card-body p-4 outofstock" onmouseover="sessionStorage.setItem('ProductName','${data[x].productName}')">
                <div class="text-center outofstock">
                    <!-- Product name-->
                    <h5 class="fw-bolder outofstock">${data[x].productName}</h5>
                    <h5 class="fw-bolder outofstock">Quantity Left: ${data[x].productQuantity - counter2}</h5>
            ...
            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent outofstock" ">
                <div class=" text-center outofstock"><a class="btn btn-outline-dark mt-auto  " href="Store.html">
                    <div id="${data[x].productId}" onClick="sessionStorage.productid=${data[x].productId}">Add To Cart</div> </a> </div>
            </div>
